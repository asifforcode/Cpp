        ...
        const fetchQuestions = async () => {
            try {
                const response = await fetch(
                    `${base_url}/api/questions?query=&page=${page}&limit=50&type=ANAGRAM`
                );
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <div className="p-8 bg-white shadow-md rounded-lg mx-auto max-w-4xl mt-6">
                <h1 className="text-center font-bold text-3xl mb-6 text-gray-800">Anagram Questions</h1>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {questions.map((question, index) => (
                        <div 
                            ...
                            onClick={() => handleQuestionClick(question._id)} // Handle click to fetch and navigate
                        >
